...
//       <div className="w-full mb-12 md:mb-0 lg:w-3/6 flex flex-col item-center lg:items-start justify-center"><h1 className="text-4xl lg:text-6xl font-semibold text-yellow-100 text-center lg:text-left">
...
//         <img src="https://static.vecteezy.com/system/resources/previews/047/339/498/non_2x/cozy-winter-evening-in-a-home-library-photo.jpg" alt="hero"/></div>
//     </div>
//   )
// }
  ...
  return (
    <div className="h-[80vh] flex flex-col md:flex-row items-center justify-center">
      <div className="w-full mb-12 md:mb-0 lg:w-3/6 flex flex-col items-center lg:items-start justify-center">
        ...
        <div className="mt-8">
          <Link className="text-yellow-100 text-xl lg:text-2xl font-semibold border border-yellow-100 px-10 py-2 hover:bg-zinc-800 rounded-full">
            Discover Books
          </Link>
        </div>
      </div>
      <div className="w-full lg:w-3/6 h-auto lg:h-[100%] flex items-center justify-center">
        <img
          src="https://static.vecteezy.com/system/resources/previews/047/339/498/non_2x/cozy-winter-evening-in-a-home-library-photo.jpg"
          alt="hero"
        />
      </div>
    </div>
